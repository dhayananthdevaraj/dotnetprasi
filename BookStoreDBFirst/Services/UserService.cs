...
namespace BookStoreDBFirst.Services
{
    public class UserService : IUserService
    {
        ...
        private readonly JobApplicationDbContext _context; // Add this field


        public UserService(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IConfiguration configuration, JobApplicationDbContext context)
        {
